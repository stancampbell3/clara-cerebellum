...
elseif(MACOSX_DEPENDENCIES_FROM STREQUAL "HomebrewLocal")
  ...
  set(CMAKE_INCLUDE_PATH ${CMAKE_INCLUDE_PATH}
      /usr/local/include)
  latest_subdir(OPENSSL_ROOT_DIR /usr/local/Cellar/openssl@3/)
  latest_subdir(LibArchive_ROOT /usr/local/Cellar/libarchive)
  latest_subdir(BDB_ROOT /usr/local/Cellar/berkeley-db)
